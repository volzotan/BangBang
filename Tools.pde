...
void moveViewport(){ 
  ...
  float xBeschleunigungsFaktor = /*abs(xRichtungsFaktor) * tempScrollGeschwindigkeit*/ + autoScrollX;    // AutoScrolling unabhängig vom Beschleunigungsfaktor              // ABS() ENTFERNEN ZUM SCROLLEN IN BEL. RICHTUNGEN
